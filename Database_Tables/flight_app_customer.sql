...
CREATE TABLE `customer` (
  ...
  KEY `FlightNum_idx` (`FlightNum`),
  CONSTRAINT `FlightNum` FOREIGN KEY (`FlightNum`) REFERENCES `flight` (`FlightNum`) ON DELETE SET NULL ON UPDATE CASCADE,
...
-- Dump completed on 2018-04-22 20:35:56
